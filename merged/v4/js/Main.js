...
function init()
{
    ...
    // Change background object based on notes
    //
    var bgscene = FindSceneByName( "BACKGROUND" );
    bgscene.sceneObjectsArray[0].material.side = THREE.DoubleSide;
    bgscene.sceneObjectsArray[0].material.color.r *= 1.5;
    bgscene.sceneObjectsArray[0].material.color.g *= 1.5;
    bgscene.sceneObjectsArray[0].material.color.b *= 1.5;
    ...
    gradientShader = new THREE.ShaderMaterial(
    {
        ...
        //vertexShader: document.getElementById( "GradSphereVertex" ).textContent
        //, fragmentShader: document.getElementById( "GradSphereFragment" ).textContent
    });
