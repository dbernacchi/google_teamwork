...
function update(dt)
{
    ...
    if( PX.AnimSceneArray[ PX.currentAnimIndex ].name === "SH060B_070B" )
    {
        ...
        {
            PX.AnimSceneArray[ PX.currentAnimIndex ].RemoveFrom( scene );
            PX.currentAnimName = "SHBADGE"; //"SH070B_080D";
            PX.currentAnimIndex = FindSceneIndexByName( PX.currentAnimName );
            PX.AnimSceneArray[ PX.currentAnimIndex ].AddTo( scene );
            PX.AnimSceneArray[ PX.currentAnimIndex ].SetStartTime( currentTimeMillis );
            PX.AnimSceneArray[ PX.currentAnimIndex ].state = 0;
    ...
    if( PX.AnimSceneArray[ PX.currentAnimIndex ].name === "SHBADGE" )
    {
        ...
        var tScale = ( currentTimeMillis - PX.AnimSceneArray[ PX.currentAnimIndex ].startTime ) * 0.001;
        //console.log( tScale );
        ...
        else if( PX.AnimSceneArray[ PX.currentAnimIndex ].state === 1 )
        {
            ...
            imageObj.scale.x = PX.Clamp( 3.0*(tScale-1.0), 0.001, 1.0 );
            imageObj.scale.y = PX.Clamp( 3.0*(tScale-1.0), 0.001, 1.0 );
            imageObj.scale.z = PX.Clamp( 3.0*(tScale-1.0), 0.001, 1.0 );

            infoObj.scale.x = PX.Clamp( 3*(tScale-0.5), 0.001, 1.0 );
            infoObj.scale.y = PX.Clamp( 3*(tScale-0.5), 0.001, 1.0 );
            infoObj.scale.z = PX.Clamp( 3*(tScale-0.5), 0.001, 1.0 );
        ...
        else if( PX.AnimSceneArray[ PX.currentAnimIndex ].state === 2 )
        {
            ...
            if( dirLenSq < 35*35 )
            {
                ...
                {
                    PX.AnimSceneArray[ PX.currentAnimIndex ].startMeshIndex = 0; // ( replay )
                    PX.AnimSceneArray[ PX.currentAnimIndex ].state++;
                }
            } 
            else
            {
                ...
                PX.AnimSceneArray[ PX.currentAnimIndex ].startMeshScaleStartTime = 0;
            }
            ...
            if( dirLenSq < 35*35 )
            {
                ...
                {
                    PX.AnimSceneArray[ PX.currentAnimIndex ].startMeshIndex = 1; // ( share )
                    PX.AnimSceneArray[ PX.currentAnimIndex ].state++;
                }
            }
            else
