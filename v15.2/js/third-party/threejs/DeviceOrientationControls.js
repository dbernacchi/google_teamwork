...
THREE.DeviceOrientationControls = function(object) {
  ...
  //this.autoForward = false;
    ...
    // Z points to the front of phone. Out the screen
    // Y points up. Top of the screen in portrait
    // X points right. Right side of phone in portrait
    // alpha rotates around Z
    // beta rotates around X
    // gamma rotates around Y
  this.alpha = 0;
  this.beta = 0;
  this.gamma = 0;
    this.absolute = true;
