...
function LoadData()
{
    $.when(
        ...
        , LoadSceneData( "SH090AB", "animations/sh090a-090b.js")
        , LoadSceneData( "SH090A_100I", "animations/sh090a-100i.js")
        ...
        , LoadJsonData( "SH090AB_anim", "animations/sh090a-090b.fbx.js" )
        , LoadJsonData( "SH090A_100I_anim", "animations/sh090a-100i.fbx.js" )
...
***/
    ...
    else
    {
        ...
        PX.currentAnimName = "SH090A_100I";
    }
...
****/
    ...
    //var totalAmount = scene000.meshEdgeList.length * scene000.sceneObjectsArray.length;
    //var index = 0;
    for( var j=0; j<scene000.meshEdgeList.length; j++ )
    //for( var j=0; j<scene000.uniqueMeshEdgeList.length; j++ )
    {
        ...
        //if( animEdge.a !== null )
        //    console.log( "1- ", animEdge.a.name );
        //else
        //    console.log( "1- not found" );
        //if( animEdge.b !== null )
        //    console.log( "2- ", animEdge.b.name );
        //else
    ...
    //
    var sceneSH090A_100I = FindSceneByName( "SH090A_100I" );
    for( var i=0; i<sceneSH090A_100I.sceneObjectsArray.length; i++ )
    {
        var so = sceneSH090A_100I.sceneObjectsArray[i];
...
***/
    ...
    if( PX.AnimSceneArray[ PX.currentAnimIndex ].name === "SH070B_080D" )
    {
        ...
        if( PX.AnimSceneArray[ PX.currentAnimIndex ].IsFinished() )
        {
            //console.log( "switch to SH090A_100I" );
            PX.AnimSceneArray[ PX.currentAnimIndex ].RemoveFrom( scene );
            PX.currentAnimName = "SH080D";
            PX.currentAnimIndex = FindSceneIndexByName( PX.currentAnimName );
            PX.AnimSceneArray[ PX.currentAnimIndex ].AddTo( scene );
    ...
    if( PX.AnimSceneArray[ PX.currentAnimIndex ].name === "SH080D" )
    {
        ...
        else if( PX.AnimSceneArray[ PX.currentAnimIndex ].state === 1 )
        {
            ...
            for( var i=0; i<PX.AnimSceneArray[ PX.currentAnimIndex ].sceneObjectsArray.length; i++ )
            {
                ...
                if( distanceSqr <= minRadius2*minRadius2 )
                {
                    ...
                    //phy.accel.x += repDirNorm.x * 1.1 * dx;
                    //phy.accel.y += repDirNorm.y * 1.1 * dy;
                    //phy.accel.z += repDirNorm.z * 1.1 * dz;
                } 
                else
                {
        ...
        else if( PX.AnimSceneArray[ PX.currentAnimIndex ].state === 2 )
        {
            ...
            if( avgVel <= 2.2861 )
            {
                ...
                PX.AnimSceneArray[ PX.currentAnimIndex ].RemoveFrom( scene );
                PX.currentAnimName = "SH090AB"; //"SH090A_100I";
                PX.currentAnimIndex = FindSceneIndexByName( PX.currentAnimName );
                PX.AnimSceneArray[ PX.currentAnimIndex ].AddTo( scene );
                PX.AnimSceneArray[ PX.currentAnimIndex ].SetStartTime( currentTimeMillis );
                PX.AnimSceneArray[ PX.currentAnimIndex ].state = 0;
    ...
    if( PX.AnimSceneArray[ PX.currentAnimIndex ].name === "SH090AB" )
    {
        PX.AnimSceneArray[ PX.currentAnimIndex ].Animate( currentTimeMillis );
        ...
        {
            PX.AnimSceneArray[ PX.currentAnimIndex ].RemoveFrom( scene );
            PX.currentAnimName = "SH090A_100I"; //"SH100I_110A";
            PX.currentAnimIndex = FindSceneIndexByName( PX.currentAnimName );
            PX.AnimSceneArray[ PX.currentAnimIndex ].AddTo( scene );
            PX.AnimSceneArray[ PX.currentAnimIndex ].SetStartTime( currentTimeMillis );
            PX.AnimSceneArray[ PX.currentAnimIndex ].state = 0;
    ...
    if( PX.AnimSceneArray[ PX.currentAnimIndex ].name === "SH090A_100I" )
    {
        PX.AnimSceneArray[ PX.currentAnimIndex ].Animate( currentTimeMillis );
