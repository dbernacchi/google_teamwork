...
PX.AnimScene.prototype =
{
    ...
    {
        //var visibleAnimTracks = [];
        //for( var i=0; i<this.animationTracks.length; i++ )
        //{
        //    var animTrack = this.animationTracks[ i ];
        //    var animInfo = this.animationInfoArray[ i ];

        //    if( PX.cameraFrustum !== null )
        //    {
        //        if( PX.cameraFrustum.intersectsObject( animInfo.meshRef ) )
        //        {
        //            visibleAnimTracks.push( animTrack );
        //        }
        //    }
        //    //console.log( "visible anim tracks: ", visibleAnimTracks.length );
        //}
