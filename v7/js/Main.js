...
{
    renderer = new THREE.WebGLRenderer({ antialias: true, precision: "highp", stencil: false, alpha: true });
...
***/
    ...
    var sceneSH090A_100I = FindSceneByName( "SH100I_110A" );
    for( var i=0; i<sceneSH090A_100I.sceneObjectsArray.length; i++ )
    {
        var so = sceneSH090A_100I.sceneObjectsArray[i];
...
function init()
{
  ...
  //controls.rotateUp(Math.PI / 4);
    ...
    {
        scene.add( PX.AnimSceneArray[ PX.currentAnimIndex ].scene );
