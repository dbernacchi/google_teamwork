    ...
    , Animate: function( timeInMillis )
    {
        ...
        for( var i=0; i<this.animationTracks.length; i++ )
        {
            ...
            if( animInfo.meshRef != null )
            {
                ...
                this.animationTracks[i].Animate( aTime, animInfo, this.loop );
                ...
                //animInfo.meshRef.quaternion = animInfo.orientation.clone();
                //animInfo.meshRef.quaternion = animInfo.meshRef.quaternion.multiply( rotQuat );
                //if( animInfo.meshRef.name=== "geosphere01" )
                //    console.log( animInfo.orientation );
                //animInfo.meshRef.quaternion.setFromAxisAngle( new THREE.Vector3( 0, 1, 0 ), aTime*0.001 );
