        ...
        scene.traverse(function (object)
        {
            if( object instanceof THREE.Mesh )
            {
                ...
                if( object.name.substr(0, 3) === "txt" 
                    /*|| object.material.name === "b_70b_text_das_letters3"
                    || object.material.name === "text_letters1"
                    || object.material.name === "b_80d_text_das_letters3"
                    || object.material.name === "greenBall_060b_b_70b_text_das_letters4"
                    || object.material.name === "b_80d_text_das_letters3"
                    || object.material.name === "redBall_70b_b_80d_text_das_letters3"
                    || object.material.name === "text_das_letters3"
                    || object.material.name === "text_text_das_letters3"*/
                    )
                {
	                var textMat = new THREE.ShaderMaterial( 
                    {
		                uniforms: { DiffuseMap: { type: "t", value: object.material.map } }
